...
<meta name="title" content="Trestle Academy Ghana">
<meta name="description" content="Fratenity">
<!-- Primary Meta Tags -->
<title>Trestle Academy Ghana</title>
<meta name="title" content="Trestle Academy Ghana">
<meta name="description" content="Fratenity">
				...
				<div class="dropdown">
					...
					<div class="dropdown-menu dropdown-menu-right">
						<div class="notification-list mx-h-350 customscroll" onclick="window.location.href='info.php';">
                            ...
                            <a class="btn btn-primary" href="index.php"><i class="dw dw-logout"></i> Log Out</a>
						</div>
					</div>
				</div>
			</div>
						...
						<table class="table hover multiple-select-row data-table-export nowrap">
							<thead>
								<tr>
								                               <th>id</th>
                                    <th>Action</th>
									<th class="table-plus datatable-nosort">organization_type</th>
                                    <th class="table-plus datatable-nosort">organization</th>
                                    <th class="table-plus datatable-nosort">business</th>
                                    <th class="table-plus datatable-nosort">organization_type</th>
                                    <th class="table-plus datatable-nosort">other_organization</th>
                                    
                                    <th class="table-plus datatable-nosort">Website</th>
                                    <th class="table-plus datatable-nosort">firstname</th>
                                    <th class="table-plus datatable-nosort">lastname</th>
                                    <th class="table-plus datatable-nosort">email</th>
                                    <th class="table-plus datatable-nosort">position</th>
                                    <th class="table-plus datatable-nosort">other_position</th>
                                    <th class="table-plus datatable-nosort">countryCode</th>
                                    <th class="table-plus datatable-nosort">phoneNumber</th>
                                    <th class="table-plus datatable-nosort">office_address</th>
                                    <th class="table-plus datatable-nosort">Stress_address</th>
                                    <th class="table-plus datatable-nosort">purpose</th>
                                    <th class="table-plus datatable-nosort">schooling</th>
                                    <th class="table-plus datatable-nosort">school</th>
                                    <th class="table-plus datatable-nosort">programme</th>
                                    <th class="table-plus datatable-nosort">level</th>
                                    <th class="table-plus datatable-nosort">countryCodewhatsapp</th>
                                    <th class="table-plus datatable-nosort">whatsappNumber</th>
                                    <th class="table-plus datatable-nosort">starter</th>
                                    <th class="table-plus datatable-nosort">website</th>
                                    <th class="table-plus datatable-nosort">linkedin</th>
...
-->
									...
									<td><?php echo $user['organization_type'];?></td>
                                    <td><?php echo $user['organization'];?></td>
                                    <td><?php echo $user['business'];?></td>
                                    <td><?php echo $user['organization_type'];?></td>

                                    <td><?php echo $user['other_organization'];?></td>
                                    <td><?php echo $user['Website'];?></td>
                                    <td><?php echo $user['firstname'];?></td>
                                     <td><?php echo $user['lastname'];?></td>
                                    <td><?php echo $user['email'];?></td>
                                    <td><?php echo $user['position'];?></td>
                                    <td><?php echo $user['other_position'];?></td>
                                    <td><?php echo $user['countryCode'];?></td>
                                    <td><?php echo $user['phoneNumber'];?></td>
                                    <td><?php echo $user['office_address'];?></td>
                                    <td><?php echo $user['Stress_address'];?></td>
                                    <td><?php echo $user['purpose'];?></td>
                                    <td><?php echo $user['schooling'];?></td>
                                    <td><?php echo $user['school'];?></td>
                                    <td><?php echo $user['programme'];?></td>
                                    <td><?php echo $user['level'];?></td>
                                    <td><?php echo $user['countryCodewhatsapp'];?></td>
                                    <td><?php echo $user['whatsappNumber'];?></td>
                                    <td><?php echo $user['starter'];?></td>
                                    <td><?php echo $user['website'];?></td>
